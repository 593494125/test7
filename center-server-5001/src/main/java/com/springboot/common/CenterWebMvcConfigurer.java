...
@Configuration
@CrossOrigin
public class CenterWebMvcConfigurer extends WebMvcConfigurationSupport {
...
//    private ProperiesFile prop;
    ...
    private String logfilepath1="d:/ymt_log/centermylog/";


    String[] includeUrls = new String[]{
            "/api/app/getToken","/api/a8/getToken","/api/app/uploadFile","/api/app/findFile","/api/app/autoCreateVersion", "/api/app/authorize","/api/app/simpleAuthorize","/api/app/getSixCode","/api/app/login","/api/app/appLogin","/Face/GetToken","/api/callBack/msg","/ymtfile/**","/yimatong_log/**","/ymt_log/**",
            "/swagger-resources/**", "/webjars/**", "/v2/**", "/swagger-ui.html/**","/webjars/*/*"};
    final String[] notLoginInterceptPaths = {"/api/app/getToken","/api/a8/getToken","/api/app/uploadFile","/api/app/findFile", "/api/app/autoCreateVersion","/api/app/authorize","/api/app/simpleAuthorize","/api/app/getSixCode","/api/app/login","/api/app/appLogin","/Face/GetToken","/api/callBack/msg","/swagger-resources/**", "/webjars/**","/webjars/*/*", "/v2/**", "/swagger-ui.html/**","/ymtfile/**","/yimatong_log/**","/ymt_log/**","/error"};

    private final Logger logger = LoggerFactory.getLogger(CenterWebMvcConfigurer.class);
...
//                .addResourceLocations("classpath:/META-INF/resources/");
        ...
        registry.addResourceHandler("/ymt_log/centermylog/**")
                .addResourceLocations("file:"+logfilepath1);//WID系统
        //读取配置文件中的上传路径

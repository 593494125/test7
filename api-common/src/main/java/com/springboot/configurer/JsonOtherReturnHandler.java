...
@Slf4j
public class JsonOtherReturnHandler implements HandlerMethodReturnValueHandler {

    private final Logger logger = LoggerFactory.getLogger(JsonOtherReturnHandler.class);
    ...
    public void handleReturnValue(Object returnValue, MethodParameter returnType, ModelAndViewContainer mavContainer,
        ...
        for (int i=0;i<advices.size();i++){
            ...
            if (ad.supports(returnType, null)) {
                returnValue = ad.beforeBodyWrite(returnValue, returnType, MediaType.APPLICATION_PROBLEM_JSON_UTF8, null,

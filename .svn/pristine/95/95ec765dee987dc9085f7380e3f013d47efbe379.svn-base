...
public class CodeGenerator {
    public static final String DB_URL = "jdbc:sqlserver://125.76.225.17;DatabaseName=A8ERP_153";
...
//    public static final String PASSWORD = "Jjyerp191";
    ...
    public void generateByTables(boolean serviceNameStartWithI, String... tableNames) {
        ...
        new AutoGenerator().setGlobalConfig(config)
                ...
                .setPackageInfo(
                        new PackageConfig()
                                .setParent(PACKAGE)
                                .setController("web.finance")
                                .setService("service.finance")
                                .setServiceImpl("service.impl.finance")
                                .setMapper("dao.finance")
    ...
    public static void main(String[] args) {
    	...
    	gse.generateByTables(false, "yw_pos_mx_spkh");
	}
}
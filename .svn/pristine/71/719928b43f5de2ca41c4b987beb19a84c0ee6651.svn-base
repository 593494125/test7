...
@Configuration
@CrossOrigin
public class a8WebMvcConfigurer extends WebMvcConfigurationSupport {
...
//    private ProperiesFile prop;
    ...
    private String logfilepath="d:/yimatong_log/a8mylog/";
    private String logfilepath1="d:/ymt_log/a8mylog/";
    ...
    private final Logger logger = LoggerFactory.getLogger(a8WebMvcConfigurer.class);
...
//                .addResourceLocations("classpath:/META-INF/resources/");
        ...
        registry.addResourceHandler("/yimatong_log/a8mylog/**")
                .addResourceLocations("file:"+logfilepath);//WID系统
        registry.addResourceHandler("/ymt_log/a8mylog/**")
...
//            String requestSign = JwtTokenUtil.generateToken(prop.getAppId());

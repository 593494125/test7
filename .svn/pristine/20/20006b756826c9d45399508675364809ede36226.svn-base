 ...
 * @since 2020-05-18
 */
public class YwKcKcpcdHz  extends BasePageForm implements Serializable {
...
//    private Date sjc;
    ...
    public String getNewtzrq() {
        return newtzrq;
    }

    public void setNewtzrq(String newtzrq) {
        this.newtzrq = newtzrq;
    }
